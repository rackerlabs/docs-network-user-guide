# -*- coding: utf-8 -*-
#
# Rackspace Network services user guide documentation build configuration file, created by
...
project = u'Rackspace Network services user guide'
...
extlinks = {
    ...
    'git-repo': ('https://github.com/rackerlabs/docs-network-user-guide/%s', ''),
...
#html_short_title = Rackspace Network services
...
htmlhelp_basename = 'RackspaceNetworkservicesuserguidedoc'
...
latex_documents = [
  (master_doc, 'RackspaceNetworkservicesuserguide.tex', u'Rackspace Network services user guide Documentation',
   u'Rackspace', 'manual'),
]
...
man_pages = [
    (master_doc, 'rackspacenetworkservicesuserguide', u'Rackspace Network services user guide Documentation',
     [u'Rackspace'], 1)
]
...
texinfo_documents = [
  (master_doc, 'RackspaceNetworkservicesuserguide', u'Rackspace Network services user guide Documentation',
   'Rackspace', 'RackspaceNetworkservicesuserguide', 'One line description of project.',
   'Miscellaneous'),
]
